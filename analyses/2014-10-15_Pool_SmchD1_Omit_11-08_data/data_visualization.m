...
for ctr = 1:length(plotData)
    plotScatter(plotData(ctr), 'RgTrans', figParams)
end
...
fullScreen = true;
plotScalingExp(data, 'RgTrans', figParams, fullScreen)

% Mean Rg's for all datasets
clear figParams
figParams.title = 'Mean R_g^{x,y} for TRF1 IF datasets';
figParams.ylim = [0 120];
figParams.ylabel = 'R_g^{x,y}, nm';
fullScreen = true;
errorBar = 'stdErr';
plotMeans(data, 'RgTrans', figParams, errorBar, fullScreen);
...
% Mean volume for TRF1 IF datasets
clear figParams
...
fullScreen = true;
plotScalingExpPaired(data, 'RgTrans', figParams, fullScreen)
...
errorBar = 'stdErr';
fullScreen = true;
plotMeansPaired(data, 'RgTrans', figParams, errorBar, fullScreen);
