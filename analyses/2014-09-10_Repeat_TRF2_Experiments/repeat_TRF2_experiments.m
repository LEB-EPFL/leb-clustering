...
function [data] = repeat_TRF2_experiments()
...
%==========================================================================
% SmchD1 and TRF2 from pooled data
%==========================================================================
% % Hela L
% dataIn.experimentShortName = 'SmchD1 and TRF2';
% dataIn.datasetShortName = 'L dataset';
% dataIn.rootDir = '/media/My Book/Kyle/Telomere_Data/Pooled_SmchD1_TRF2/';
% dataIn.datasetDir = 'HelaL/';
% dataIn.distributions = [];
% dataIn.fits = [];
% data = [data, dataIn]; % Appends this dataset to the data array.
% 
