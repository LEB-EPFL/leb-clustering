...
plt.ylabel('Count')
plt.savefig('output_figs/denatTest_control.svg')
plt.savefig('output_figs/denatTest_control.png')
plt.savefig('output_figs/denatTest_control.pdf')
plt.close()
...
plt.xlabel('Radius of gyration, nm')
plt.ylabel('Count')
plt.savefig('output_figs/denatTest_denatured.svg')
plt.savefig('output_figs/denatTest_denatured.png')
plt.savefig('output_figs/denatTest_denatured.pdf')
plt.close()

plt.hist(control['Control Rg'],     bins = myBins, histtype = 'step', label = 'Control')
plt.hist(denatured['Denatured Rg'], bins = myBins, color = 'black', histtype = 'step', label = 'Denatured')
plt.xlabel('Radius of gyration, nm')
plt.ylabel('Count')
plt.grid(True)
plt.legend()
plt.savefig('output_figs/denatTest_both.svg')
plt.savefig('output_figs/denatTest_both.png')
plt.savefig('output_figs/denatTest_both.pdf')
plt.close()
