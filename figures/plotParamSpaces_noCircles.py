...
plt.savefig('output_figs/HelaL_param_space_noCircles.svg')
plt.savefig('output_figs/HelaL_param_space_noCircles.pdf')
plt.savefig('output_figs/HelaL_param_space_noCircles.png')
...
plt.xlabel('Packing ratio, bp/nm')
plt.ylabel('Persistence length, nm')
plt.savefig('output_figs/HelaS_param_space_noCircles.svg')
plt.savefig('output_figs/HelaS_param_space_noCircles.pdf')
plt.savefig('output_figs/HelaS_param_space_noCircles.png')
