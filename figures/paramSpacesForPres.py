...
plt.savefig('presentation_figs/HelaL_param_space_dists.svg')
plt.savefig('presentation_figs/HelaL_param_space_dists.pdf')
plt.savefig('presentation_figs/HelaL_param_space_dists.png')
...
fig, ((ax1, ax2),(ax3, ax4)) = plt.subplots(2, 2, sharex = True, sharey = True, dpi = 600)
...
# Squeeze subplots into a smaller bounding box, relative to the figure
plt.tight_layout(w_pad = 0.5, rect = [0, 0, 1, 0.9])
plt.savefig('presentation_figs/HelaS_param_space_dists.svg')
plt.savefig('presentation_figs/HelaS_param_space_dists.pdf')
plt.savefig('presentation_figs/HelaS_param_space_dists.png')
